...
import { renderIdentityHero, renderIdentityHeroScript } from './identity-hero';
...
export function renderHomePage(options: HomePageOptions): string {
  ...
  return renderPageShell({
    ...
    scripts: `${renderFeedScript(locale, messages, guidePath)}${renderCopyScript()}${renderSkillInstallPreferenceScript()}${renderKeyboardShortcutsScript(guidePath)}${renderIdentityHeroScript()}`,
