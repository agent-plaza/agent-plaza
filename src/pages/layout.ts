...
export const VBG_CUSTOM_STYLES = `
  ...
  .vbg-identity-hero {
    margin-block: var(--vbg-space-6) var(--vbg-space-8);
    padding: clamp(1.5rem, 4vw, 2.75rem);
    border: 1px solid var(--vbg-border);
    border-radius: var(--vbg-radius-lg);
    background:
      radial-gradient(120% 80% at 0% 0%, color-mix(in srgb, var(--vbg-accent) 12%, transparent), transparent 55%),
      color-mix(in srgb, var(--vbg-surface) 94%, var(--vbg-accent) 6%);
  }

  .vbg-identity-eyebrow {
    margin: 0 0 var(--vbg-space-2);
    font-size: var(--vbg-type-caption);
    font-weight: var(--vbg-weight-medium);
    letter-spacing: 0.14em;
    text-transform: uppercase;
    color: var(--vbg-text-muted);
  }
  ...
  .vbg-identity-preview {
    margin-bottom: var(--vbg-space-4);
  }

  .vbg-identity-handle-line {
    margin: 0;
  ...
  .vbg-identity-input-wrap {
    display: grid;
    gap: var(--vbg-space-2);
    max-width: 28rem;
  }

  .vbg-identity-input-label {
    font-size: var(--vbg-type-caption);
    color: var(--vbg-text-muted);
  }
  ...
  .vbg-identity-input {
    ...
    background: var(--vbg-surface);
    color: var(--vbg-text);
    font: inherit;
  }

  .vbg-identity-input:focus-visible {
    outline: 2px solid var(--vbg-focus);
    outline-offset: 2px;
  }

  .vbg-identity-input-reserved {
    border-color: color-mix(in srgb, var(--vbg-danger, #c0392b) 55%, var(--vbg-border));
  }
  ...
  .vbg-identity-status-reserved {
    color: color-mix(in srgb, var(--vbg-danger, #c0392b) 85%, var(--vbg-text));
  }

  .vbg-identity-status-available {
    color: color-mix(in srgb, var(--vbg-accent) 70%, var(--vbg-text));
  }

  .vbg-identity-caption {
    margin: var(--vbg-space-4) 0 0;
    max-width: 42rem;
    font-size: var(--vbg-type-body);
    color: var(--vbg-text-muted);
